...
import com.xll.data.stream.manager.domain.aggregate.system.entity.vo.MetaVo;
...
public class ISysMenuServiceImpl implements ISysMenuService {
    ...
    public List<Long> selectMenuCheckedListByRoleId(Long roleId) {
        return sysMenuDao.selectMenuCheckedListByRoleId(roleId);
    }
    ...
    public List<Long> selectMenuHalfCheckedListByRoleId(Long roleId) {
        return sysMenuDao.selectMenuHalfCheckedListByRoleId(roleId);
    }
    ...
    public boolean hasChildByMenuId(Long menuId) {
        return sysMenuDao.hasChildByMenuId(menuId);
    }
