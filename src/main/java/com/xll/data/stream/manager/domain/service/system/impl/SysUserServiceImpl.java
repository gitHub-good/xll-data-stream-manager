...
import com.xll.data.stream.manager.domain.aggregate.system.dao.*;
import com.xll.data.stream.manager.domain.aggregate.system.entity.*;
...
import com.xll.data.stream.manager.infrastructure.common.utils.bean.BeanValidators;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public String checkUserNameUnique(String userName) {
        int count = sysUserRepository.checkUserNameUnique(userName);
        if (count > 0) {
    ...
    public String checkPhoneUnique(SysUser user) {
        ...
        SysUser info = sysUserRepository.checkPhoneUnique(user.getPhone());
