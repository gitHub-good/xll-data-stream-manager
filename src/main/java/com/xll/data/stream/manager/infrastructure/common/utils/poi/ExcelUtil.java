package com.xll.data.stream.manager.infrastructure.common.utils.poi;

import com.xll.data.stream.manager.infrastructure.common.annotation.Excel;
import com.xll.data.stream.manager.infrastructure.common.annotation.Excels;
...
import com.xll.data.stream.manager.infrastructure.common.exception.UtilException;
...
import com.xll.data.stream.manager.infrastructure.common.utils.file.FileTypeUtils;
import com.xll.data.stream.manager.infrastructure.common.utils.file.FileUtils;
import com.xll.data.stream.manager.infrastructure.common.utils.file.ImageUtils;
import com.xll.data.stream.manager.infrastructure.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    {
        String downloadPath = DStreamConfig.getDownloadPath() + filename;
