...
import com.xll.data.stream.manager.domain.service.system.ISysUserService;
...
import com.xll.data.stream.manager.infrastructure.common.enums.BusinessType;
import com.xll.data.stream.manager.infrastructure.common.utils.StringUtils;
import com.xll.data.stream.manager.infrastructure.common.utils.poi.ExcelUtil;
...
public class SysRoleController extends BaseController {
    ...
    public AjaxResult deptTree(@PathVariable("roleId") Long roleId) {
        ...
        ajax.put("checkedKeys", deptService.selectDeptCheckedListByRoleId(roleId));
        ajax.put("halfCheckedKeys", deptService.selectDeptHalfCheckedListByRoleId(roleId));
