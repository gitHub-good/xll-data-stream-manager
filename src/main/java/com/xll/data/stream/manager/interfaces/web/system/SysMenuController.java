...
public class SysMenuController extends BaseController {
    ...
    public AjaxResult roleMenuTreeselect(@PathVariable("roleId") Long roleId) {
        ...
        ajax.put("checkedKeys", menuService.selectMenuCheckedListByRoleId(roleId));
        ajax.put("halfCheckedKeys", menuService.selectMenuHalfCheckedListByRoleId(roleId));
