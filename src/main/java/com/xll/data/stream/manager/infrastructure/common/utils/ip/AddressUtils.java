package com.xll.data.stream.manager.infrastructure.common.utils.ip;
...
import com.xll.data.stream.manager.infrastructure.common.utils.http.HttpUtils;
...
public class AddressUtils {
    ...
    public static String getRealAddressByIP(String ip) {
        ...
        if (DStreamConfig.isAddressEnabled()) {
            try {
