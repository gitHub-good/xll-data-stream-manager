...
import com.xll.data.stream.manager.infrastructure.common.utils.sign.Base64;
import com.xll.data.stream.manager.infrastructure.common.utils.uuid.IdUtils;
...
public class CaptchaController {
    ...
    public AjaxResult getCode(HttpServletResponse response) throws IOException {
        ...
        // 生成验证码
        String captchaType = DStreamConfig.getCaptchaType();
