package com.xll.data.stream.manager.infrastructure.framework.aspectj;

import com.alibaba.fastjson2.JSON;
import com.xll.data.stream.manager.domain.aggregate.system.entity.SysOperateLog;
import com.xll.data.stream.manager.infrastructure.common.annotation.Log;
import com.xll.data.stream.manager.infrastructure.common.core.domain.model.LoginUser;
import com.xll.data.stream.manager.infrastructure.common.enums.BusinessStatus;
import com.xll.data.stream.manager.infrastructure.common.enums.HttpMethod;
import com.xll.data.stream.manager.infrastructure.common.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
    ...
    private void setRequestValue(JoinPoint joinPoint, SysOperateLog operateLog) throws Exception {
        ...
        if (HttpMethod.PUT.name().equals(requestMethod) || HttpMethod.POST.name().equals(requestMethod)) {
            ...
            operateLog.setOperParam(StringUtils.substring(params, 0, 2000));
        } else {
            Map<?, ?> paramsMap = (Map<?, ?>) ServletUtils.getRequest().getAttribute(HandlerMapping.URI_TEMPLATE_VARIABLES_ATTRIBUTE);
            operateLog.setOperParam(StringUtils.substring(paramsMap.toString(), 0, 2000));
        }
    }
