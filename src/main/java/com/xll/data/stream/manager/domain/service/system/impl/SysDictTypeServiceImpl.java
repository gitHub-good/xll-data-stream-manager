...
import com.xll.data.stream.manager.domain.service.system.ISysDictTypeService;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
    ...
    public List<SysDictData> selectDictDataByType(String dictType) {
        ...
        dictDatas = dictDataDao.selectDictDataByType(dictType);
        if (StringUtils.isNotEmpty(dictDatas)) {
    ...
    public void deleteDictTypeByIds(Long[] dictIds) {
        for (Long dictId : dictIds) {
            ...
            dictTypeDao.deleteDictTypeById(dictId);
    ...
    public void loadingDictCache() {
        ...
        Map<String, List<SysDictData>> dictDataMap = dictDataDao.selectDictDataList(dictData).stream().collect(Collectors.groupingBy(SysDictData::getDictType));
    ...
    public boolean insertDictType(SysDictType dict) {
        if (dictTypeDao.insertDictType(dict)) {
    ...
    public boolean updateDictType(SysDictType dict) {
        SysDictType oldDict = dictTypeDao.selectDictTypeById(dict.getDictId());
        dictDataDao.updateDictDataType(oldDict.getDictType(), dict.getDictType());
        if (dictTypeDao.updateDictType(dict)) {
            List<SysDictData> dictDatas = dictDataDao.selectDictDataByType(dict.getDictType());
